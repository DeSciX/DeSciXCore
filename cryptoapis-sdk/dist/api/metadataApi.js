...
exports.MetadataApi = exports.MetadataApiApiKeys = void 0;
...
(function (MetadataApiApiKeys) {
    MetadataApiApiKeys[MetadataApiApiKeys["ApiKey"] = 0] = "ApiKey";
})(MetadataApiApiKeys || (exports.MetadataApiApiKeys = MetadataApiApiKeys = {}));
var MetadataApi = (function () {
    ...
    Object.defineProperty(MetadataApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    MetadataApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    MetadataApi.prototype.listSupportedAssets = function (context_1, limit_1, offset_1, type_1) {
        return __awaiter(this, arguments, void 0, function (context, limit, offset, type, options) {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            if (options === void 0) { options = { headers: {} }; }
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/market-data/metadata/assets';
                ...
                if (type !== undefined) {
                    localVarQueryParameters['type'] = models_1.ObjectSerializer.serialize(type, "'fiat' | 'crypto'");
                }
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, "ListSupportedAssetsR");
