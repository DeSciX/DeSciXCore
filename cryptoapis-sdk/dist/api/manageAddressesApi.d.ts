...
import { DeleteSyncedAddressR } from '../model/deleteSyncedAddressR';
...
export declare enum ManageAddressesApiApiKeys {
    ApiKey = 0
}
export declare class ManageAddressesApi {
    ...
    setApiKey(key: ManageAddressesApiApiKeys, value: string): void;
    ...
    deleteSyncedAddress(address: string, blockchain: 'polygon' | 'ethereum' | 'dash' | 'tron' | 'dogecoin' | 'litecoin' | 'zcash' | 'bitcoin-cash' | 'bitcoin' | 'ethereum-classic' | 'binance-smart-chain', network: 'mainnet' | 'sepolia' | 'mumbai' | 'amoy' | 'testnet' | 'nile' | 'mordor', context?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: DeleteSyncedAddressR;
    }>;
