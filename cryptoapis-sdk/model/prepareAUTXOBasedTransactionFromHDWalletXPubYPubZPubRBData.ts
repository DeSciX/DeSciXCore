...
export class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBData {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "item",
            "baseName": "item",
            "type": "PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem"
        }    ];

    static getAttributeTypeMap() {
        return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBData.attributeTypeMap;
    }
}
